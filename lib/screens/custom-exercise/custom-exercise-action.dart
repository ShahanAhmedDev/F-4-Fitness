...
import 'package:pose_detection_teachable/constants/lifecycle-event-handler.dart';
import 'package:pose_detection_teachable/model/savedData.dart';
...
import '../../model/exerciseData.dart';
...
String CounterMinutes = '00', CounterSeconds = '5';
                                              ...
                                              if (index >= States.length - 1) {
                                                setState(() {
                                                  ...
                                                  for (int i = 0;
                                                      ...
                                                      i++) {
                                                    totalDuration +=
                                                        listCustomExercise[i].secondExercise;
                                                  }
                                                  var hiveBox =
                                                      Hive.box('savedData');
                                                  print(
